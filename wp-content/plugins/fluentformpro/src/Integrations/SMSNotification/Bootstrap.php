...
//        add_filter('fluentform/notifying_async_sms_notification', '__return_false');
    ...
    public function pushIntegration($integrations, $formId)
    {
        $integrations[$this->integrationKey] = [
            ...
            'configure_message'     => __('SMS Notification is not configured yet! Please configure your SMS api first', 'fluentformpro'),
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'tips'         => __('Send SMS Notification conditionally based on your submission values', 'fluentformpro'),
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (empty($feedData['receiver_number']) || empty($feedData['message'])) {
            do_action('fluentform/integration_action_result', $feed, 'failed',  __('No valid receiver_number found', 'fluentformpro'));
            return;
        }
        ...
        if (is_wp_error($response)) {
            ...
            do_action('fluentform/integration_action_result', $feed, 'success', __('Twilio SMS feed has been successfully initialed and pushed data', 'fluentformpro'));
        }
    }
