...
if ( ! class_exists( 'AOFgfonts' ) ) {
    class AOFgfonts {
        ...
        function powerbox_update_gfonts() {
          // Define REVIEW9JA_GOOGLE_FONTS_API_KEY in wp-config.php to refresh this list.
          $google_api_key = defined( 'REVIEW9JA_GOOGLE_FONTS_API_KEY' ) ? REVIEW9JA_GOOGLE_FONTS_API_KEY : '';

          if ( empty( $google_api_key ) ) {
              return $this->get_gfonts();
          }
