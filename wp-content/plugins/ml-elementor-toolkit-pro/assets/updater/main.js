		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response.success) {
					...
					licenseContainer.find('label.license-label').hide();
					licenseContainer.find('input.activate-license').hide();
					licenseContainer.find('input.deactivate-license').show();
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response.success) {
					...
					licenseContainer.find('label.license-label').show();
					licenseContainer.find('input.activate-license').show();
					licenseContainer.find('input.deactivate-license').hide();
					licenseContainer.find('input.license').prop('type', 'text').val('');
				} else {
					var errorContainer = licenseContainer.find('.current-license-error');
