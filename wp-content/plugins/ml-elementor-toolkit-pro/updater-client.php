...
if ( ! class_exists( 'ML_Elementor_Toolkit_Pro_Updater' ) ) {
	class ML_Elementor_Toolkit_Pro_Updater {
		...
		public function __construct( $file, $product_id, $software_version, $plugin_or_theme, $api_url, $software_title = '', $text_domain = '' ) {
			...
			if ( is_admin() ) {
				...
				$this->wc_am_activation_tab_key          = 'mylisting_elementor_toolkit';
				$this->wc_am_deactivation_tab_key        = 'mylisting_elementor_toolkit_deactivate';
