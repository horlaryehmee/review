...
class TwitterWidget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Social Ninja X (Twitter)', 'wp-social-reviews' );
    }
    ...
    protected function register_general_controls(){
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Social Ninja X (Twitter) Feed', 'wp-social-reviews'),
            ]
        );
    ...
    protected function render() {
        ...
        if(!empty($twitter_template_list)){
            // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Checking for editor context, not processing sensitive form data
