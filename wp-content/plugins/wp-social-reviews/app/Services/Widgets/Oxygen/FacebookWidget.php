...
class FacebookWidget extends OxygenEl
{
    ...
    function controls() {
        ...
        $fb_content_section->typographySection( __('Typography', 'wp-social-reviews'), '.wpsr-fb-feed-item .wpsr-fb-feed-content', $this );
    ...
    function render( $options, $defaults, $content ) {
        ...
        if ( function_exists('do_oxygen_elements') ) {
            ...
            echo do_oxygen_elements('[wp_social_ninja id="'. esc_attr($options['wpsr_facebook']) .'" platform="facebook_feed"]');
        } else {
            echo do_shortcode('[wp_social_ninja id="'. esc_attr($options['wpsr_facebook']) .'" platform="facebook_feed"]');
        }
    }
