...
<div class="wpsr-tweet-quoted-status">
    <?php $wpsr_permalink = 'https://twitter.com/' . Arr::get($feed, 'user.username', '') . '/status/' . Arr::get($feed, 'id', ''); ?>
    <a href="<?php echo esc_url($wpsr_permalink); ?>" target="_blank" class="wpsr-tweet-quoted-status-link"></a>
