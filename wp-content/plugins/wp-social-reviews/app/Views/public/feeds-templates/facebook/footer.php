...
echo '<div class="wpsr-fb-feed-footer wpsr-fb-feed-follow-button-group wpsr-row ' . esc_attr($wpsr_mt_30) . '">';
//pagination
$wpsr_feed_type = Arr::get($feed_settings, 'source_settings.feed_type', '');
if (count($feeds) > $paginate && $layout_type !== 'carousel' && $pagination_type === 'load_more' && $wpsr_feed_type !== 'album_feed') {
    do_action('wpsocialreviews/load_more_button', $feed_settings, $templateId, $paginate, $layout_type, $total, $wpsr_feed_type);
}
