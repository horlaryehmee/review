...
<div class="wpd-opt-row" data-wpd-opt="showAvatars">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["showAvatars"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[showAvatars]" id="showAvatars">
...
<div class="wpd-opt-row" data-wpd-opt="defaultAvatarUrlForUser">
    ...
    <div class="wpd-opt-input">
        <input type="url" value="<?php echo esc_attr($this->thread_layouts["defaultAvatarUrlForUser"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[defaultAvatarUrlForUser]"
               id="defaultAvatarUrlForUser"/>
    </div>
    <div class="wpd-opt-doc">
...
<div class="wpd-opt-row" data-wpd-opt="defaultAvatarUrlForGuest">
    ...
    <div class="wpd-opt-input">
        <input type="url" value="<?php echo esc_attr($this->thread_layouts["defaultAvatarUrlForGuest"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[defaultAvatarUrlForGuest]"
               id="defaultAvatarUrlForGuest"/>
    </div>
    <div class="wpd-opt-doc">
...
<div class="wpd-opt-row" data-wpd-opt="changeAvatarsEverywhere">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["changeAvatarsEverywhere"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[changeAvatarsEverywhere]"
                   id="changeAvatarsEverywhere">
...
<div class="wpd-opt-row" data-wpd-opt="showVotingButtons">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["showVotingButtons"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[showVotingButtons]"
                   id="showVotingButtons">
...
<div class="wpd-opt-row" data-wpd-opt="votingButtonsIcon">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switch-field" style="min-width: 220px;">
            <input type="radio" <?php checked($this->thread_layouts["votingButtonsIcon"] === "fa-plus|fa-minus") ?>
                   value="fa-plus|fa-minus"
...
<div class="wpd-opt-row" data-wpd-opt="enableDislikeButton">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["enableDislikeButton"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[enableDislikeButton]"
                   id="enableDislikeButton">
...
<div class="wpd-opt-row" data-wpd-opt="isGuestCanVote">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["isGuestCanVote"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[isGuestCanVote]" id="isGuestCanVote">
...
<div class="wpd-opt-row" data-wpd-opt="highlightVotingButtons">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["highlightVotingButtons"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[highlightVotingButtons]"
                   id="highlightVotingButtons">
...
<div class="wpd-opt-row" data-wpd-opt="showCommentLink">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["showCommentLink"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[showCommentLink]"
                   id="showCommentLink">
...
<div class="wpd-opt-row" data-wpd-opt="showCommentDate">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->thread_layouts["showCommentDate"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_THREAD_LAYOUTS); ?>[showCommentDate]"
                   id="showCommentDate">
