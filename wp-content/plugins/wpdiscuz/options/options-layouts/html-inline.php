...
<div class="wpd-opt-row">
    ...
    <div class="wpd-opt-doc" style="padding-top: 10px;">
        <a href="https://wpdiscuz.com/docs/wpdiscuz-7/plugin-settings/inline-commenting/"
...
<div class="wpd-opt-row" data-wpd-opt="showInlineFilterButton">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->inline["showInlineFilterButton"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_INLINE); ?>[showInlineFilterButton]"
                   id="showInlineFilterButton">
...
<div class="wpd-opt-row" data-wpd-opt="inlineFeedbackAttractionType">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-radio">
            <input type="radio"
                   value="disable" <?php checked("disable" === $this->inline["inlineFeedbackAttractionType"]); ?>
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_INLINE); ?>[inlineFeedbackAttractionType]"
                   id="inlineFeedbackAttractionTypeDisable" class="inlineFeedbackAttractionType"/>
        ...
        <div class="wpd-radio">
            <input type="radio"
                   value="blink" <?php checked("blink" === $this->inline["inlineFeedbackAttractionType"]); ?>
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_INLINE); ?>[inlineFeedbackAttractionType]"
                   id="inlineFeedbackAttractionTypeBlink" class="inlineFeedbackAttractionType"/>
        ...
        <div class="wpd-radio">
            <input type="radio"
                   value="scroll_open" <?php checked("scroll_open" === $this->inline["inlineFeedbackAttractionType"]); ?>
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_INLINE); ?>[inlineFeedbackAttractionType]"
                   id="inlineFeedbackAttractionTypeScrollOpen" class="inlineFeedbackAttractionType"/>
