...
<div class="wpd-opt-row">
    ...
    <div class="wpd-opt-doc" style="padding-top: 10px;">
        <a href="https://wpdiscuz.com/docs/wpdiscuz-7/plugin-settings/article-and-comment-rating/"
...
<div class="wpd-opt-row" data-wpd-opt="enablePostRatingSchema">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->rating["enablePostRatingSchema"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[enablePostRatingSchema]"
                   id="enablePostRatingSchema">
...
<div class="wpd-opt-row" data-wpd-opt="displayRatingOnPost">
    ...
    <div class="wpd-opt-input">
        <div>
            <input type="checkbox" <?php checked(in_array("before_comment_form", $this->rating["displayRatingOnPost"])) ?>
                   value="before_comment_form"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[displayRatingOnPost][]"
                   id="displayRatingOnPostBeforeCommentForm" style="margin:0px; vertical-align: middle;"/>
            <label for="displayRatingOnPostBeforeCommentForm"><?php esc_html_e("Before Comment Form", "wpdiscuz"); ?></label>
        </div>
        <div>
            <input type="checkbox" <?php checked(in_array("before", $this->rating["displayRatingOnPost"])) ?>
                   value="before" name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[displayRatingOnPost][]"
                   id="displayRatingOnPostBefore" style="margin:0px; vertical-align: middle;"/>
            <label for="displayRatingOnPostBefore"><?php esc_html_e("Before Content", "wpdiscuz"); ?></label>
        </div>
        <div>
            <input type="checkbox" <?php checked(in_array("after", $this->rating["displayRatingOnPost"])) ?>
                   value="after" name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[displayRatingOnPost][]"
                   id="displayRatingOnPostAfter" style="margin:0px; vertical-align: middle;"/>
            <label for="displayRatingOnPostAfter"><?php esc_html_e("After Content", "wpdiscuz"); ?></label>
        </div>
        <div>
            <input type="checkbox" <?php checked($this->rating["ratingCssOnNoneSingular"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[ratingCssOnNoneSingular]"
                   id="ratingCssOnNoneSingular" style="margin:0px; vertical-align: middle;"/>
    ...
    <div class="wpd-opt-input" style="width: calc(100% - 40px);">
        ...
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->rating["ratingHoverColor"]); ?>"
                   id="ratingHovratingHoverColorerColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[ratingHoverColor]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Rating Stars Hover Color", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->rating["ratingInactiveColor"]); ?>" id="ratingInactiveColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[ratingInactiveColor]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
            <label><?php esc_html_e("Rating Stars Inactive Color", "wpdiscuz"); ?></label>
        </div>
        <div class="wpd-color-wrap">
            <input type="text" class="wpdiscuz-color-picker regular-text"
                   value="<?php echo esc_attr($this->rating["ratingActiveColor"]); ?>" id="ratingActiveColor"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_RATING); ?>[ratingActiveColor]"
                   placeholder="<?php esc_attr_e("Example: #00FF00", "wpdiscuz"); ?>"/>
