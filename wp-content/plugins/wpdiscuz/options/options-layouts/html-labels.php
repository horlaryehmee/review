        ...
        <div class="wpd-multi-check" style="padding-top: 10px; padding-left: 10px;">
            ...
            foreach ($this->labels["blogRoleLabels"] as $role => $value) {
                ...
                <div class="wpd-mublock-inline" style="width: 200px; min-width: 33%;">
                    <input type="checkbox" <?php checked((int)$value); ?> value="1"
                           name="<?php echo esc_attr(WpdiscuzCore::TAB_LABELS); ?>[blogRoleLabels][<?php echo esc_attr($role); ?>]"
                           id="blogRoleLabels<?php echo esc_attr($role); ?>"
    ...
    <div class="wpd-opt-input" style="width: calc(100% - 40px);">
        ...
        foreach ($this->labels["blogRoles"] as $roleName => $color) {
            ...
            <div class="wpd-color-wrap" style="width: 200px; min-width: 33%;">
                <input type="text" title="<?php esc_attr(esc_attr_e("label color", "wpdiscuz")); ?>"
                       class="wpdiscuz-color-picker regular-text" value="<?php echo esc_attr($color); ?>"
                       id="blogRoles_<?php echo esc_attr($roleName); ?>"
