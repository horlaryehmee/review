...
<div>
	...
	<div class="form-group mb30">
		<h4 class="m-heading mb5"><?php _ex( 'Allow switching listing package', 'WP Admin > Listings > Settings', 'my-listing' ) ?></h4>
		<p class="mt0 mb10">
			<?php _ex( 'Choose whether users can switch listing plans and whether a listing moved to a new plan must be approved by an administrator. When moderation is required, the original listings will be unpublished pending admin approval.', 'WP Admin > Listings > Settings', 'my-listing' ) ?>
		</p>
		<div class="select-wrapper dib">
			<select name="job_manager_user_switch_plan">
				<?php $value = $this->get_setting( 'user_can_switch_listing_plan' ) ?>
				<option value="yes" <?php selected( 'yes', $value ) ?>><?php _ex( 'Users can switch without admin approval', 'WP Admin > Listings > Settings', 'my-listing' ) ?></option>
				<option value="yes_moderated" <?php selected( 'yes_moderated', $value ) ?>><?php _ex( 'Users can switch, but new listing with new plan requires admin approval', 'WP Admin > Listings > Settings', 'my-listing' ) ?></option>
				<option value="no" <?php selected( 'no', $value ) ?>><?php _ex( 'Users cannot switch listing plans', 'WP Admin > Listings > Settings', 'my-listing' ) ?></option>
			</select>
		</div>
	</div>
