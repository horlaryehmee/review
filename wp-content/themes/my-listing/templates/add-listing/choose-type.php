...
<section class="i-section choose-type">
	<div class="container-fluid">
		...
		<?php foreach ($data['listing_types'] as $listing_type):
			...
			$individualCardClass = $cardClass . ' elementor-repeater-item-' . esc_attr( $listing_type['_id'] );
			?>
			<div class="<?php echo esc_attr( $individualCardClass ) ?> col-sm-6 col-xs-12 ac-category">
				<div class="cat-card">
